    ...
    function IndexAction()
      {
        ...
        $collection = $collection->addAttributeToFilter('type_id', 'downloadable')->addAttributeToFilter('status', '1')->addAttributeToFilter('flag', "no")->addFieldToFilter('digital_fulfillment_date', array(
            'gt' => date("Y-m-d H:i:s", strtotime('-10 day'))
        ))->addAttributeToSelect('digital_parent')->addAttributeToSelect('digital_fulfillment_date');
